...
class TestRpc(ParametrizedTestCase):
	...
	def setUpClass(cls):
		...
		contractApi.invoke_function(cls.m_contractaddr_right, "put", "", "1", argvs = [{"type": "bytearray","value": cls.m_getstorage_contract_key},{"type": "bytearray","value": cls.m_getstorage_contract_value}], node_index = 0)
