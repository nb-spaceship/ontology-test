...
class config():
	...
	#(contract_addr, contract_tx_hash) = API.contract().deploy_contract_full(testpath+"/resource/test.neo", "name", "desc", 0)
	
	(contract_addr, contract_tx_hash) = API.contract().deploy_contract_full(testpath+"/resource/test.neo")
