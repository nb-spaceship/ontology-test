...
//		catch(SDKException e) {
//			System.out.println(e.toString());
//			String exp="com.github.ontio.sdk.exception.SDKException: {\"Desc\":\"Account Error,encryptedPriKey address password not match.\",\"Error\":51015}";
...
//	
//	@Test
//	public void test_abnormal_009_importAccount() throws Exception {
//		OntTest.logger().description("----------importAccount----------");
//		
//		try {
//			OntTest.logger().step("1.生成账户");
...
//		catch(SDKException e) {
//			System.out.println(e.toString());
//			String exp="com.github.ontio.sdk.exception.SDKException: {\"Desc\":\"wallet account exist\",\"Error\":58005}";
//			assertEquals(true,e.toString().equals(exp));
//			
//		}
//		catch(Exception e) {
...
//		catch(SDKException e) {
//			System.out.println(e.toString());
//			String exp="com.github.ontio.sdk.exception.SDKException: {\"Desc\":\"Other Error,normalize error\",\"Error\":59000}";
//			assertEquals(true,e.toString().equals(exp));
//		}
//
//		catch(Exception e) {
...
//			System.out.println(createaccinfo);
//			String password = "123456";
...
//		catch(SDKException e) {
//			System.out.println(e.toString());
//			String exp="com.github.ontio.sdk.exception.SDKException: {\"Desc\":\"Other Error,Account null\",\"Error\":59000}";
//			assertEquals(true,e.toString().equals(exp));
//		}
//		catch(Exception e) {
//			OntTest.logger().error(e.toString());
...
//	
//	@Test
//	public void test_abnormal_043_getAccountInfo() throws Exception {
//		OntTest.logger().description("----------getAccountInfo----------");
//		
//		try {
//			OntTest.logger().step("1.创建账户");
...
//			System.out.println(createaccinfo);
//			System.out.println(createaccinfo1);			
//			String password = "123456";
//			String address = createaccinfo.address;
...
//			System.out.println("第一个创建成功！");
//			OntTest.sdk().getWalletMgr().createAccount("123456");
//			System.out.println("第二个创建成功！");
//			OntTest.sdk().getWalletMgr().createAccount("123456");
//			System.out.println("第三个创建成功！");
//			System.out.println("查询所有账号");
//			
