...
class TestMutiContract_41(ParametrizedTestCase):
    def test_main(self):
        ...
        try:
            ...
            # 用户B调用智能合约A中的A方法
            (result, response) = invoke_function_approve(contract_address, "A", ontID_A, ontID_B, 10)
            if not result:
    ...
    def invoke_function_approve(self, contract_address, function_str, from_str, to_str, amount):
        request = {
            "REQUEST": {
                "Qid": "t",
